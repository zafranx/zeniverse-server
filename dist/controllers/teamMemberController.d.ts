...
export declare const getAllTeamMembersNew: (req: AuthRequest, res: Response) => Promise<void>;
...
export declare const toggleTeamMemberFeatured: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
